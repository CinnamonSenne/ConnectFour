                    ...
                    if (Canvas[i,j] == "x" || Canvas[i,j] == "o")
                    {
                        ...
                        if (j != 0 && j < KOLOMMEN - 2)
                        {
                            ...
                            if (Canvas[i, arrayIndex] == Canvas[i, arrayIndex - 1] &&
                                ...
                                Canvas[i, arrayIndex] == Canvas[i, arrayIndex + 2])
                            {
                                return true; 
                            }
                        }
                        ...
                        if (i > 2)
                        {
                            ...
                            if (Canvas[i, arrayIndex] == Canvas[i - 1, arrayIndex] &&
                                  ...
                                  Canvas[i, arrayIndex] == Canvas[i - 3, arrayIndex])
                            {
                                return true;
                            }
                        }
                        ...
                        if (i > 2)
                        {
                             ...
                             { 
                                 ...
                                 if (Canvas[i, arrayIndex] == Canvas[i - 1, arrayIndex - 1] &&
                                     Canvas[i, arrayIndex] == Canvas[i - 2, arrayIndex - 2] &&
                                     Canvas[i, arrayIndex] == Canvas[i - 3, arrayIndex - 3])
                                 {
                                     return true; 
                                 }
                             }
